...
import Foundation
import UIKit
@IBDesignable open class HorizontalSlider: UIControl {
...
//        }
        ...
        slider.setThumbImage(UIImage(named: "Ellipse"), for: .highlighted)
        slider.setThumbImage(UIImage(named: "Ellipse"), for: .focused)
    ...
    override open var intrinsicContentSize: CGSize {
        get {
             return CGSize(width: slider.intrinsicContentSize.width, height: slider.intrinsicContentSize.height)
        }
    }
